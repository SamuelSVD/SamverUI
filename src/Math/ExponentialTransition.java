...
public class ExponentialTransition extends Function{
  ArrayList<Function> f;
  double transition_period;
  public ExponentialTransition(ArrayList<Double> points, double transition_period) {
...
//      System.out.printf("i:%d\n",i);
      ...
      Function fun = MathUtils.makeExponential(0, x0, transition_period, points.get(i));
      f.add(fun);
